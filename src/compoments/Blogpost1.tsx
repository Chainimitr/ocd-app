        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-lg-8">
              ...
              <hr />
              {/* Date/Time */}
              <p>โพสต์เมื่อวันที่ 18 ธันวาคม 2567 โดยนายชัยนิมิตร วรวงษ์</p>
              <hr />
              {/* Post Content */}
              <p className="lead">แนวคิดปรัชญากับการพัฒนาองค์การภาครัฐ</p>
              <p>
                ...
                <ol className="ml-4" style={{ listStyleType: "deciml" }}>
                  ...
                  <li>
                    ...
                    <ul className="ml-4" style={{ listStyleType: "circle" }}>
                      {" "}
                      <li>ภาวะผู้นำ</li>
                      <li>กระบวนการกลุ่ม</li> <li>การออกแบบงาน</li>{" "}
                      <li>กลยุทธ์</li> <li>รูปแบบองค์การ</li>
              ...
              <p>
                ต้องอยู่บนรากฐานของความรู้และค่านิยม ดังนี้{" "}
                <ol className="ml-4" style={{ listStyleType: "deciml" }}>
                  <li>
              ...
              1.3Refreezing: การรักษาผลของการเปลี่ยนแปลง
              <ul className="ml-4">
                Refreezing:
              ...
              <ul className="ml-4" style={{ listStyleType: "circle" }}>
                <li>
                  ...
                  ด้าน-วัฒนธรรม-บรรทัดฐาน-นโยบาย-โครงสร้างองค์การ
                </li>{" "}
                <li>
                  Refreezing
              ...
              <ol className="ml-4" style={{ listStyleType: "disc" }}>
                ...
                <li>
                  ...
                  <ul className="ml-4" style={{ listStyleType: "circle" }}>
                    ...
                    <li>Do</li>
                    ดำเนินการ (กระบวนการ, กิจกรรม, โครงการ)
                    <li>Check</li>
